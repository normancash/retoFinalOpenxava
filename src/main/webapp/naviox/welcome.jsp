...
In retoOpenxava-labels_en.properties:
retoOpenxava=My application
retoOpenxava[description]=My application does this and that

In retoOpenxava-messages_en.properties:
